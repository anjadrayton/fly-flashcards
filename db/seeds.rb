...
Flashcard.create(question: "What characterizes a Hash?", answer: "Sets of key, value pairs", question_type: multi, deck: deck3, choice1: "Text between quotation marks.", choice2: "The only hash I know is hashbrown?", choice3: "Hashes are not real. #conspiracy")
Flashcard.create(question: "How man cups of coffee was consumed during project weeks?", answer: "Too much!", question_type: multi, deck: deck3, choice1: "0-5", choice2: "6-10", choice3: "11-19")
Flashcard.create(question: "What were the most best things about covid lockdown?", answer: "8.59am wake up time~Watching lectures in bed~Unlimited coffees~Pre-livecode naps", question_type: sort, deck: deck3, sort1: "8.59am wake up time", sort2: "Watching lectures in bed", sort3: "Unlimited coffees", sort4: "Pre-livecode naps")
...
Flashcard.create(question: "Best part of the bootcamp?", answer: "Meeting the amazing people of batch 680~Georges's lectures~Paired programming~The fact its almost over", question_type: sort, deck: deck3, sort1: "Paired programming", sort2: "Georges's lectures", sort3: "Meeting the amazing people of batch 680" , sort4: "The fact its almost over")
