...
Flashcard.create(question: "How many cups of coffee was consumed during project weeks?", answer: "Too much!", question_type: multi, deck: deck3, choice1: "0-9", choice2: "10-19", choice3: "20-29")
Flashcard.create(question: "Rank the best things about covid lockdown?", answer: "8.59am wake up time~Watching lectures in bed~Unlimited coffees~Pre-livecode naps", question_type: sort, deck: deck3, sort1: "Watching lectures in bed", sort2: "8.59am wake up time", sort3: "Pre-livecode naps", sort4: "Unlimited coffees")
